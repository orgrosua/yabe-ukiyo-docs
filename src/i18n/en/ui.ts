export default {
	...
	// Site settings
	'site.title': 'Yabe Ukiyo Documentation',
	'site.description': 'The Remote Templates Manager Plugin for Bricks.',
	'site.og.imageSrc': '/default-og-image.png',
	'site.og.imageAlt':
		'The Remote Templates Manager Plugin for Bricks — Yabe Ukiyo',
	// Left Sidebar
